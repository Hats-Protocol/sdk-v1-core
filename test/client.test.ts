...
describe("Basic tests", () => {
  ...
  describe("Hats client is initialized", () => {
    ...
    describe("Subgraph gqlGetHatsOfTree", () => {
      let res: bigint[];
      beforeAll(async () => {
        res = await hatsClientGoerli.gqlGetHatsOfTree(135);
      }, 100000);

      test("Test getTreeHats result", () => {
        expect(res[0]).toBe(
          BigInt(
            "0x0000008700000000000000000000000000000000000000000000000000000000"
          )
        );
        expect(res[1]).toBe(
          BigInt(
            "0x0000008700010000000000000000000000000000000000000000000000000000"
          )
        );
        expect(res[2]).toBe(
          BigInt(
            "0x0000008700020000000000000000000000000000000000000000000000000000"
          )
        );
        expect(res[3]).toBe(
          BigInt(
            "0x0000008700020001000000000000000000000000000000000000000000000000"
          )
        );
      });
    });
    ...
    describe("Subgraph gqlGetWearersPerHatInTree", () => {
      ...
      beforeAll(async () => {
        res = await hatsClientGoerli.gqlGetWearersPerHatInTree(135);
      }, 100000);
